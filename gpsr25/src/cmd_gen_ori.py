...
class CommandGenerator:
    ...
    color_list = ["blue", "black", "white", "red", "orange", "gray"]
    clothe_list = ["t shirt", "shirt", "blouse", "jacket"]
    clothes_list = ["t shirts", "shirts", "blouses", "jackets"]
    color_clothe_list = []
    ...
    def generate_command_start(self, cmd_category="", difficulty=0):
        ...
        person_cmd_list = ["goToLoc", "findPrsInRoom", "meetPrsAtBeac", "countPrsInRoom", "tellPrsInfoInLoc",
                           ...
                           #"greetClothDscInRm",
                        #    "greetNameInRm", 
                           "meetNameAtLocThenFindInRm", "countClothPrsInRoom",
